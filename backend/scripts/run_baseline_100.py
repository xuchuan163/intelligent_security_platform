"""Run 100-project smoke load baseline and write perf report (Phase 4-C.3)."""
...
DEFAULT_JSON = REPO_ROOT / "docs" / "perf" / "baseline_100.json"
DEFAULT_MD = REPO_ROOT / "docs" / "perf" / "baseline_100.md"


def main() -> int:
    parser = argparse.ArgumentParser(description="Seed 100 projects and run smoke load baseline.")
    ...
    exit_code, payload = run_performance_baseline(
        BaselineRunConfig(
            ...
            markdown_title="Phase 4 性能基线 — 100 项目冒烟压测",
            payload_title="Phase 4-C.3 100 项目冒烟压测基线",
